...
async function testUmbraSDK() {
    try {
        ...
        try {
            const airdropSignature = await connection.requestAirdrop(publicKeypair.publicKey, 2 * LAMPORTS_PER_SOL);
        ...
        try {
            ...
            const result = await client.depositConfidentiallyIntoMixerPool(depositAmount, publicKeypair.publicKey, WSOL_MINT_ADDRESS, publicKeypair.publicKey, // Use self as relayer
            {
        ...
        try {
            ...
            const publicResult = await client.depositPublicallyIntoMixerPool(depositAmount, publicKeypair.publicKey, WSOL_MINT_ADDRESS, {
                mode: 'connection'
            });
