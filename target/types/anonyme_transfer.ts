 ...
 * IDL can be found at `target/idl/anonyme_transfer.json`.
 */
export type AnonymeTransfer = {
  "address": "A26JcC1bfDZ1wV5Vkdo4rrwDcUzorjT55a6RGp7bAfzx",
  "metadata": {
    "name": "anonymeTransfer",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "instructions": [
    ...
    {
      "name": "decryptPdaAddressCallback",
      "discriminator": [
        127,
        196,
        255,
    ...
    {
      "name": "encryptPdaAddressCallback",
      "discriminator": [
        45,
        99,
        22,
