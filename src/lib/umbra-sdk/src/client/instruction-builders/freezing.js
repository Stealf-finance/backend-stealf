...
export async function buildFreezeArciumUserAccountInstruction(txAccounts) {
    try {
        ...
        throw new InstructionBuildingError(`Failed to build freeze Arcium user account instruction: ${error instanceof Error ? error.message : String(error)}`, error instanceof Error ? error : undefined);
    }
}
/**
...
export async function buildFreezeArciumTokenAccountInstruction(txAccounts) {
    try {
        ...
        throw new InstructionBuildingError(`Failed to build freeze Arcium token account instruction: ${error instanceof Error ? error.message : String(error)}`, error instanceof Error ? error : undefined);
    }
}
