import { LAMPORTS_PER_SOL, SystemProgram, Transaction as SolanaTransaction } from '@solana/web3.js';
...
class SimplePrivateTransferService {
     ...
     */
    async transferToPrivateWallet(params) {
     ...
     */
    async getPrivateWalletBalance(userId, keypair) {
        try {
